package com.addie.client.models;
...
public class MilyWayStargateModel extends SinglePartEntityModel {
    private final ModelPart stargate;
    public MilyWayStargateModel(ModelPart stargate) {
        this.stargate = stargate.getChild("stargate");
    }
